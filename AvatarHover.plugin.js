...
global.AvatarHover = function () {
    ...
    getSettingsPanel() {
      ...
      return `<div id="settings_AvatarHover">${function () {
        ...
        ref = {
          ...
          isHoverServerIcons: "Server Icons",
          isHoverEmojisandReactions: "Emoji's",
          isHoverEmotsInMenu: "Also hover emojis in the menu"
        };
        results = [];
        for (k in ref) {
          v = ref[k];
  ...
  updateQualifier = function () {
    return qualifier = [settings.isHoverGuilds ? "#app-mount, .wrapper-3t9DeA:not(.avatar-SmRMf2), .mask-1l8v16, .displayAvatar-1wWlVM, .avatar-3bWpYy, .embedAuthorIcon--1zR3L" : void 0, settings.isHoverChannels ? ".avatarDefault-35WC3R, .avatarSpeaking-3MqCHL, .modeConnected-2IEL4z .avatarSmall-2CW6I1, .avatarContainer-2inGBK, .privateChannels-1nO12o .avatar-28BJzY" : void 0, settings.isHoverFriends ? ".friendsTable-133bsv .avatarSmall--gkJKA, .activityFeed-28jde9 .image-33JSyf, .friendsTable-133bsv .icon-3o6xvg" : void 0, settings.isHoverChatMessages ? ".message-1PNnaP .wrapper-3t9DeA, .message-1PNnaP .embedAuthorIcon--1zR3L" : void 0, settings.isHoverChatUsers ? ".membersWrap-2h-GB4 .avatarWrapper-3B0ndJ" : void 0, settings.isHoverServerIcons ? ".wrapper-1BJsBx" : void 0, settings.isHoverEmojisandReactions ? ".emoji, .emoji-236_Ij" : void 0, settings.isHoverEmotsInMenu ? ".emojiItem-109bjA" : void 0].filter(function (s) {
      return s != null;
    }).join(", ");
  };
  ...
  defaultSettings = {
    ...
    isHoverServerIcons: false,
    isHoverEmojisandReactions: false,
    isHoverEmotsInMenu: false
  };
